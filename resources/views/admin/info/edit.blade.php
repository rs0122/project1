    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>コラム編集</h2>
                <form action="{{ action('Admin\InfoController@update') }}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                        <ul>
                ...
                <div class="row mt-5">
                    <div class="col-md-4 mx-auto">
                        <h2>編集履歴</h2>
                        <ul class="list-group">
                            @if ($information_form->histories != NULL)
                                @foreach ($information_form->histories as $history)
